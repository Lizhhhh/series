        ...
        <el-tab-pane label="技能" name="skills">
          ...
          <el-row type="flex" style="flex-wrap: wrap;">
            <el-col
              ...
              :key="i"
              style=" border-bottom: 1px solid #008080; margin-top: 1rem"
            >
              <el-form-item label="名称">
...
export default {
  ...
  created() {
    this.fetchItems()  // 获取装备
    this.fetchCategories()  // 获取类型
    this.id && this.fetch() // 获取基本信息
  }
}
</script>
